...
async def criar_diagnostico(
    ...
    anamnese = repo_anamnese.obter_por_id(anamnese_id)
...
async def obter_diagnostico(
    ...
    anamnese = repo_anamnese.obter_por_id(diagnostico.anamnese_id)
    ...
    return {
        ...
        "anamnese": {
            ...
            "respostas": [resposta.model_dump(mode="json") for resposta in anamnese.respostas],
        },
        "revisao": revisao,
